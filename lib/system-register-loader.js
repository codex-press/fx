(function (global, factory) {
  ...
  (global.SystemRegisterLoader = factory());
  ...
  function SystemRegisterLoader (baseKey) {
    ...
    if (typeof envGlobal.System.registerDynamic === 'function')
      var prevRegisterDynamic = envGlobal.System.registerDynamic;
    envGlobal.System.register = function () {
      loader.register.apply(loader, arguments);
      if (prevRegister)
        prevRegister.apply(this, arguments);
    };
    envGlobal.System.registerDynamic = function () {
  ...
  function scriptLoad (src, resolve, reject) {
    ...
    // TWF
    script.src = 'http://localhost:8000' + src;
